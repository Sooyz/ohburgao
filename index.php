...
<?php if (@$_SESSION['VALID'] and ( $modulo != 'login' )) { ?>
    ...
    <html lang="br">
        <head>
            ...
            <script src="<?php echo JS; ?>page-level-plugins/jquery.mask.min.js" type="text/javascript"></script>    
            <script src="<?php echo JS; ?>page-level-plugins/jquery.mask.js" type="text/javascript"></script>    
