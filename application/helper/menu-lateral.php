...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <?php if($_SESSION['LOGIN']['id_perfil'] == 1){?>
        <li class="nav-item start ">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "atendimento/cadastroPedido"; ?>" class="nav-link ">
                            <span class="title">Cadastrar Pedido</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "atendimento/listarPedidos"; ?>" class="nav-link ">
                            <span class="title">Listar Pedidos</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "atendimento/pedidosCozinha"; ?>" class="nav-link ">
                            <span class="title">PEDIDOS COZINHA</span>
                        </a>
                    </li>
            ...
            <li class="nav-item start ">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "adm/cadastroBurgao"; ?>" class="nav-link ">
                            <span class="title">Cadastrar Burgão</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "adm/cadastroProduto"; ?>" class="nav-link ">
                            <span class="title">Cadastrar Produto</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "adm/cadastroPromocao"; ?>" class="nav-link ">
                            <span class="title">Cadastrar Promoção</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "adm/listaBurgoes"; ?>" class="nav-link ">
                            <span class="title">Listar Burgões</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "adm/listarProdutos"; ?>" class="nav-link ">
                            <span class="title">Listar Produtos</span>
                        </a>
                    </li>
                    <li class="nav-item start ">
                        <a href="<?php echo RAIZ . "adm/listarPromocoes"; ?>" class="nav-link ">
                            <span class="title">Listar Promoções</span>
                        </a>
                    </li>
                   
                </ul>
            </li>    
        <?php }//else if($_SESSOIN['LOGIN']['id_perfil'] == 3){?>
