...
<html lang="pt-br">
    ...
    <body class="login">
            ...
            <div class="logo">
                <center>
                    <table>
                        <tr>
                            <td>
                                <img src="<?php echo IMG; ?>logo/logo.jpg" height="100" alt="Defensoria Pública da União" >
                            </td>
                        </tr>
                    </table>
                </center>
        ...
        <div class="clearfix visible-xs-block visible-sm-block">
            <p align="center">
                <img src="<?php echo IMG; ?>logo/logo.jpg" height="100" alt="">
                <br/><br/>
        ...
        <div class="content">
            ...
            <form class="login-form" role="form" name="form_login" method="POST" accept-charset="utf-8" action="<?php echo CONTROLLER . 'login.php' ?>">
                ...
                <h3 class="form-title" align="center">OH SISTEMÃO!</h3>

                <?php require HELPER . "mensagem.php"; ?>

                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Perfil</label>
                ...
                <div class="create-account">
                    <center>
                        <p>Informações do Sistema procure o <b>LÉOZIN</b></p>
                        <p>+55 (61) 98289-7744<p/>
                    </center>
                </div>
            </form>
        ...
        <div class="copyright">
            ...
            </script> &copy; Sistema Oh Burgão V 1.0 - Beta
        </div>
