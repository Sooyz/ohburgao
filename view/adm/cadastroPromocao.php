            ...
            <div class="tab-pane" >
                <div class="portlet box blue-madison" style="border-radius: 4px;">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus"></i> Cadastrar Promoção </div>
                    ...
                    <div class="portlet-body form">
                        ...
                        <input type="hidden" name="arrDadosForm[method]" value="cadastrarPromo">
                            <div class="form-body">
                                <h3 class="form-section">Nova Promoção</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Nome da Promoção<span class="required" aria-required="true">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Burgão da Promoção<span class="required" aria-required="true">*</span></label>
                                            <select class="bs-select form-control" name="arrDadosForm[id_burgao]" >
