            ...
            <div class="tab-pane" >
                <div class="portlet box blue-madison" style="border-radius: 4px;">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-plus"></i> Cadastrar Produto </div>
                    ...
                    <div class="portlet-body form">
                        ...
                        <input type="hidden" name="arrDadosForm[method]" value="cadastrarProduto">
                            <div class="form-body">
                                <h3 class="form-section">Novo Produto</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Nome do Produto<span class="required" aria-required="true">*</span></label>
